...
const LoveStory = () => {
    ...
    return (
        <section id="our_love_story" className={`${styles.our_love_story} d-flex align-items-center`}>
            <div className={styles.our_love_story_decor_left} data-aos="fade-right" data-aos-delay="400" data-aos-duration="600">
                <Image alt="decor-left-our-story" src={'/assets/flower-0007.png'} layout="fill" />
            </div>
            <div className={styles.our_love_story_decor_right} data-aos="fade-left" data-aos-delay="400" data-aos-duration="600">
                <Image alt="decor-left-our-story" src={'/assets/flower-0008.png'} layout="fill" />
            </div>
            <div className={`${styles.love_story_container} container`}>
                <div className={styles.section_title} data-aos="fade-down">Our Love Story</div>
                ...
                <div className="text-center mb-10" style={{marginTop:"40px"}} data-aos="fade-up">
                    <p className="p-2">
                        <i>"Mahasuci (Allah) yang telah menciptakan semuanya berpasang-pasangan, baik dari apa yang
                        ditumbuhkan oleh bumi dan dari diri mereka sendiri, maupun dari apa yang tidak mereka ketahui."</i>
                        <br />
                        <i>QS. Yasin:36</i>
                    </p>
                </div>
